...
describe('Error Handling', () => {
  ...
  test('throws error if input is too short', () => {
  ...
  test('throws error if input contains a mix of letters and numbers', () => {
  ...
  test('returns uppercase string if input is valid', () => {

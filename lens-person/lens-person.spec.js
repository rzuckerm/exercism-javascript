...
describe('nameLens', () => {
  ...
  test('should ensure immutability when setting a new name', () => {
...
describe('bornAtLens', () => {
  test('should get the address for where the person was born', () => {
    expect(bornAtLens.get(person)).toEqual(person.born.bornAt);
  });

  test('should set a new address for where the person was born', () => {
  ...
  test('should ensure immutability when setting a new birth address', () => {
...
describe('streetLens', () => {
  ...
  test('should ensure immutability when setting a new street', () => {
